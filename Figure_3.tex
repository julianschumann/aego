...
\draw[white](0,0) rectangle (12,6.5);
	...
	\addplot3[
	 ...
	 shader= interp,
            ...
            point meta min= 0,   
            point meta max=  315,
            ] table[x=a, y=b, z=c] from {Figure_11/2d_projection.txt};
	\addplot3 [very thin, black, opacity=0.5,
            ] table[x=a, y=b, z=c] from {Figure_11/2d_mesh.txt};
	\addplot3 [thin, black,
            ] table[x=a, y=b, z=c] from {Figure_11/2d_mesh_2.txt};
	...
	\node[black,thin,left] at (1,5.7) {\textbf{A}};
             \begin{scope}[scale=0.6,xshift=13.33cm, yshift=7.5cm]
                 \node[] at (2.5,1.25)
                     {\includegraphics[width=3cm]{Figure_11/vis_1_X1.png}};
	\draw[step=0.0555555cm,black!50!white, very thin,shift={(0,0)}] (0,0)  grid(5,2.5);
             ...
             \begin{scope}[scale=0.6,xshift=13.33cm, yshift=4.16666cm]
                 \node[] at (2.5,1.25)
                     {\includegraphics[width=3cm]{Figure_11/vis_1_dX1.png}};
	\draw[step=0.0555555cm,black!50!white, very thin,shift={(0,0)}] (0,0)  grid(5,2.5);
                 \draw[black,thin] (0,0) rectangle(5,2.5);% Bearings
             ...
             \begin{scope}[scale=0.6,xshift=13.33cm, yshift=0.83333cm]
                 \node[] at (2.5,1.25)
                     {\includegraphics[width=3cm]{Figure_11/vis_1_dX2.png}};
	\draw[step=0.0555555cm,black!50!white, very thin,shift={(0,0)}] (0,0)  grid(5,2.5);
                 \draw[black,thin] (0,0) rectangle(5,2.5);% Bearings
